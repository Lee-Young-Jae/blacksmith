...
export const POTENTIAL_POOLS: Record<PotentialTier, PotentialOption[]> = {
  ...
  epic: [
    ...
    { stat: 'hp', minValue: 50, maxValue: 200, isPercentage: false, weight: 15 },
  ...
  unique: [
    ...
    { stat: 'hp', minValue: 5, maxValue: 8, isPercentage: true, weight: 15 },
  ...
  legendary: [
    ...
    { stat: 'hp', minValue: 8, maxValue: 12, isPercentage: true, weight: 15 },
